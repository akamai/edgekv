...
```
	 ...
	 * @param {object} [$0.edgekv_access_tokens={}] token name and token value for each namespace. The structure of this argument assumes the same as the token creation command by Akamai CLI.
